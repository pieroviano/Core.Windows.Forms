...
* `MediaTypeFormatter` and the JSON, XML and form-url-encoded implementations
* `HttpContentExtensions` — `ReadAsAsync<T>`, `ReadAsFormDataAsync`
* `FormDataCollection`, `MediaTypeHeaderValueExtensions`, the formatter collection
