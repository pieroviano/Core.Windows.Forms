...
using System.Data;
// port: System.Data.Linq (LINQ to SQL) is not available on .NET Core
...
namespace System.Web.Mvc.Html
{
    internal static class DefaultEditorTemplates
    {
        ...
        internal static string HiddenInputTemplate(HtmlHelper html)
        {
            ...
            byte [] modelAsBinary = null; // port: a Linq.Binary cannot reach this template
        ...
        private static bool ShouldShow(ModelMetadata metadata, TemplateInfo templateInfo)
        {
            return
                ...
                && metadata.ModelType.FullName != "System.Data.EntityState" && metadata.ModelType.FullName != "System.Data.Entity.EntityState"
