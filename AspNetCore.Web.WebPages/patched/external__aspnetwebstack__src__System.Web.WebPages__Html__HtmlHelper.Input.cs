...
using System.Linq; // port: System.Data.Linq (LINQ to SQL) is not available on .NET Core
...
namespace System.Web.WebPages.Html
{
    public partial class HtmlHelper
    {
        ...
        {
            byte [] binaryValue = null; // port: a System.Data.Linq.Binary cannot reach this method
            if (binaryValue != null)
            {
